...
export const categoriesPreviewSection =
...
export const trendingMoviesPreviewList = document.querySelector(
    ".trendingPreview-movieList"
);
export const categoriesPreviewList = document.querySelector(
    ".categoriesPreview-list"
);
export const movieDetailCategoriesList = document.querySelector(
    "#movieDetail .categories-list"
);
export const relatedMoviesContainer = document.querySelector(
...
export const headerCategoryTitle = document.querySelector(
